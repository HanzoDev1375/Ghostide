...
public interface PythonParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PythonParser#fstringOrString}.
	 * @param ctx the parse tree
	 */
	void enterFstringOrString(PythonParser.FstringOrStringContext ctx);
	/**
	 * Exit a parse tree produced by {@link PythonParser#fstringOrString}.
	 * @param ctx the parse tree
	 */
	void exitFstringOrString(PythonParser.FstringOrStringContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link PythonParser#firstPartOfArgs}.
	 * @param ctx the parse tree
	 */
	void enterFirstPartOfArgs(PythonParser.FirstPartOfArgsContext ctx);
	/**
	 * Exit a parse tree produced by {@link PythonParser#firstPartOfArgs}.
	 * @param ctx the parse tree
	 */
	void exitFirstPartOfArgs(PythonParser.FirstPartOfArgsContext ctx);
	/**
	 * Enter a parse tree produced by {@link PythonParser#secondPartOfArgs}.
	 * @param ctx the parse tree
	 */
	void enterSecondPartOfArgs(PythonParser.SecondPartOfArgsContext ctx);
	/**
	 * Exit a parse tree produced by {@link PythonParser#secondPartOfArgs}.
	 * @param ctx the parse tree
	 */
	void exitSecondPartOfArgs(PythonParser.SecondPartOfArgsContext ctx);
	/**
