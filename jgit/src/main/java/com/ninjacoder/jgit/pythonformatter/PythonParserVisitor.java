...
public interface PythonParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#fstringOrString}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFstringOrString(PythonParser.FstringOrStringContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#firstPartOfArgs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFirstPartOfArgs(PythonParser.FirstPartOfArgsContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#secondPartOfArgs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSecondPartOfArgs(PythonParser.SecondPartOfArgsContext ctx);
	/**
