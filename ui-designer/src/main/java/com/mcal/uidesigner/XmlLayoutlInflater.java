...
import com.mcal.uidesigner.widget.StudioSelectionBorder;
...
public abstract class XmlLayoutlInflater implements UndoManager.UndoRedoListener {
  ...
  private boolean useStudioStyle = false;

  public XmlLayoutlInflater(
  ...
  public void setUseStudioStyle(boolean useStudioStyle) {
    this.useStudioStyle = useStudioStyle;
    refresh();
  }

  public boolean isUseStudioStyle() {
    return useStudioStyle;
  }
  ...
  public void share() {
    final Uri logUri =
        FileProvider.getUriForFile(context, context.getPackageName(), new File(xmlFilePath));
  ...
  public void setIDAttribute(
      ...
      @NonNull XmlLayoutProperties.PropertySpec property,
      Element otherNode,
      String id) {
  ...
  public List<AttributeValue> getAttributes(
      PropertyObject viewObj, PropertyObject layoutParamsObj, Element node) {
  ...
  public void setAttribute(
      Element node, @NonNull XmlLayoutProperties.PropertySpec property, String value) {
  ...
  private void removeLayoutAttributes(Element node) {
    ...
    for (XmlLayoutProperties.PropertySpec property : arr) {
      if (!(property == XmlLayoutProperties.LAYOUT_WIDTH
          || property == XmlLayoutProperties.LAYOUT_HEIGHT
          || !node.hasAttribute(property.attrName))) {
        node.removeAttribute(property.attrName);
      }
    }
  }
  ...
  public void addViewInside(
      @NonNull Element node,
      NewWidget widget,
      @NonNull Element otherNode,
      @NonNull XmlLayoutProperties.PropertySpec layoutProperty,
      String id) {
    Element newNode = createElement(widget);
  ...
  private void refresh() {
    ...
    if (border || editMode) {
      ...
      if (useStudioStyle) {
        StudioSelectionBorder studioBorder =
            new StudioSelectionBorder(context, container) {
              @Override
        ...
        studioBorder.setEnabled(editMode);
        studioBorder.setShowSelection(editMode);
        parentView.addView(studioBorder, -1, -1);
      } else {
        ClickableBorder clickableBorder =
            new ClickableBorder(context, container) {
              @Override
    ...
    if (inflateException != null) {
      ...
      if (!inflateException.getMessage().contains("no element")) {
        textView.setText(
            context.getString(R.string.can_not_view_the_layout) + inflateException.getMessage());
      } else if (editMode) {
  ...
  public String getViewID(@NonNull Node node) {
    ...
    if (!(attr instanceof Attr)
        || (idValue = ((Attr) attr).getValue()) == null
        || !idValue.startsWith("@+id/")) {
      return null;
    }
  ...
  private void inflateElements(
      @NonNull NodeList nodes, ViewGroup parent, XmlLayoutEditView parentEditView, int depth) {
    ...
    for (int i = 0; i < nodes.getLength(); i++) {
      ...
      if (node.getNodeType() == 1) {
        ...
        boolean showEditView =
            editMode
                && !(view instanceof TableRow)
                && (selectModeClickRunnable == null || selectModeNodes.contains(node));
        XmlLayoutEditView editView =
            new XmlLayoutEditView(
                context,
  ...
  private void configureView(View view, boolean editMode) {
    ...
    if (className.equals("android.widget.Button")
        || className.equals("androidx.appcompat.widget.AppCompatButton")
        || className.equals("com.google.android.material.button.MaterialButton")) {
      try {
    ...
    if (className.equals("android.widget.ImageButton")
        || className.equals("androidx.appcompat.widget.AppCompatImageButton")) {
      try {
    ...
    if (className.equals("android.widget.TextView")
        || className.equals("androidx.appcompat.widget.AppCompatTextView")
        || className.equals("com.google.android.material.textview.MaterialTextView")) {
      try {
    ...
    if (className.equals("android.widget.EditText")
        || className.equals("androidx.appcompat.widget.AppCompatEditText")) {
      try {
        EditText et = (EditText) view;
        if (et.getHint() == null || et.getHint().length() == 0) {
    ...
    // ====== TextInputLayout ======
    if (className.equals("com.google.android.material.textfield.TextInputLayout")) {
      try {
    ...
    if (className.equals("com.google.android.material.textfield.TextInputEditText")
        || className.equals("com.google.android.material.textfield.MaterialAutoCompleteTextView")) {
      try {
        TextView tv = (TextView) view;
        if (tv.getHint() == null || tv.getHint().length() == 0) {
    ...
    if (className.equals("android.widget.ImageView")
        || className.equals("androidx.appcompat.widget.AppCompatImageView")) {
      try {
    ...
    // ====== ShapeableImageView ======
    if (className.equals("com.google.android.material.imageview.ShapeableImageView")) {
      try {
        ShapeableImageView siv = (ShapeableImageView) view;
        siv.setImageResource(android.R.drawable.ic_menu_gallery);
      } catch (Throwable ignored) {
      }
    }

    // ====== FAB ======
    if (className.equals("com.google.android.material.floatingactionbutton.FloatingActionButton")) {
      try {
    ...
    if (className.equals(
      ...
      try {
        ExtendedFloatingActionButton efab = (ExtendedFloatingActionButton) view;
        efab.setText("Action");
        efab.setIconResource(android.R.drawable.ic_input_add);
      } catch (Throwable ignored) {
      }
    }
    ...
    if (className.equals("android.widget.ProgressBar")
        || className.equals("androidx.core.widget.ContentLoadingProgressBar")) {
      try {
    ...
    if (className.equals("com.google.android.material.progressindicator.LinearProgressIndicator")) {
      try {
        LinearProgressIndicator lpi = (LinearProgressIndicator) view;
        lpi.setProgress(65);
      } catch (Throwable ignored) {
      }
    }
    ...
    if (className.equals(
      ...
      try {
        CircularProgressIndicator cpi = (CircularProgressIndicator) view;
        cpi.setProgress(65);
      } catch (Throwable ignored) {
      }
    }
    ...
    if (className.equals("android.widget.SeekBar")
        || className.equals("androidx.appcompat.widget.AppCompatSeekBar")) {
      try {
    ...
    // ====== Slider ======
    if (className.equals("com.google.android.material.slider.Slider")) {
      try {
    ...
    // ====== RangeSlider ======
    if (className.equals("com.google.android.material.slider.RangeSlider")) {
      try {
        RangeSlider rs = (RangeSlider) view;
        rs.setValueFrom(0f);
        rs.setValueTo(100f);
        rs.setValues(30f, 70f);
      } catch (Throwable ignored) {
      }
    }

    // ====== RatingBar ======
    if (className.equals("android.widget.RatingBar")) {
      try {
    ...
    // ====== Chip ======
    if (className.equals("com.google.android.material.chip.Chip")) {
      try {
        Chip chip = (Chip) view;
        if (chip.getText() == null || chip.getText().length() == 0) {
          chip.setText("Chip");
        }
      } catch (Throwable ignored) {
      }
    ...
    // ====== ChipGroup ======
    if (className.equals("com.google.android.material.chip.ChipGroup")) {
      try {
        view.setMinimumHeight((int) (40 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }

    // ====== MaterialCardView ======
    if (className.equals("com.google.android.material.card.MaterialCardView")) {
      try {
        MaterialCardView card = (MaterialCardView) view;
        card.setMinimumHeight((int) (120 * context.getResources().getDisplayMetrics().density));
        card.setMinimumWidth((int) (200 * context.getResources().getDisplayMetrics().density));
    ...
    // ====== TabLayout ======
    if (className.equals("com.google.android.material.tabs.TabLayout")) {
      try {
    ...
    // ====== TabItem ======
    if (className.equals("com.google.android.material.tabs.TabItem")) {
      try {
        view.setMinimumHeight((int) (48 * context.getResources().getDisplayMetrics().density));
        view.setMinimumWidth((int) (64 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }

    // ====== MaterialToolbar ======
    if (className.equals("com.google.android.material.appbar.MaterialToolbar")) {
      try {
    ...
    // ====== AppBarLayout ======
    if (className.equals("com.google.android.material.appbar.AppBarLayout")) {
      try {
        view.setMinimumHeight((int) (56 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }

    // ====== CollapsingToolbarLayout ======
    if (className.equals("com.google.android.material.appbar.CollapsingToolbarLayout")) {
      try {
    ...
    // ====== NavigationView ======
    if (className.equals("com.google.android.material.navigation.NavigationView")) {
      try {
        ...
        menu.add(0, 2, 0, "Gallery").setIcon(android.R.drawable.ic_menu_gallery);
        menu.add(0, 3, 0, "Slideshow").setIcon(android.R.drawable.ic_menu_slideshow);
      } catch (Throwable ignored) {
      }
    }

    // ====== BottomNavigationView ======
    if (className.equals("com.google.android.material.bottomnavigation.BottomNavigationView")) {
      try {
        BottomNavigationView bnv = (BottomNavigationView) view;
        android.view.Menu menu = bnv.getMenu();
        menu.add(0, 1, 0, "Home").setIcon(android.R.drawable.ic_menu_compass);
    ...
    // ====== BottomAppBar ======
    if (className.equals("com.google.android.material.bottomappbar.BottomAppBar")) {
      try {
        BottomAppBar bab = (BottomAppBar) view;
        bab.setNavigationIcon(android.R.drawable.ic_menu_close_clear_cancel);
      } catch (Throwable ignored) {
      }
    }

    // ====== MaterialButtonToggleGroup ======
    if (className.equals("com.google.android.material.button.MaterialButtonToggleGroup")) {
      try {
        view.setMinimumHeight((int) (48 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    ...
    // ====== SearchBar ======
    if (className.equals("com.google.android.material.search.SearchBar")) {
      try {
        SearchBar sb = (SearchBar) view;
        sb.setHint("Search...");
      } catch (Throwable ignored) {
      }
    }
    ...
    // ====== SearchView ======
    if (className.equals("com.google.android.material.search.SearchView")) {
      try {
    ...
    // ====== ViewPager2 ======
    if (className.equals("androidx.viewpager2.widget.ViewPager2")) {
      fillViewPager2((ViewPager2) view);
    }

    // ====== RecyclerView ======
    if (className.equals("androidx.recyclerview.widget.RecyclerView")) {
      fillRecyclerView((RecyclerView) view);
    }

    // ====== NestedScrollView/ScrollView/HorizontalScrollView ======
    if (className.equals("androidx.core.widget.NestedScrollView")
        || className.equals("android.widget.ScrollView")
        || className.equals("android.widget.HorizontalScrollView")) {
      try {
        view.setMinimumHeight((int) (150 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }
    ...
    // ====== DatePicker ======
    if (className.equals("android.widget.DatePicker")) {
      try {
        view.setMinimumHeight((int) (200 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }

    // ====== TimePicker ======
    if (className.equals("android.widget.TimePicker")) {
      try {
        view.setMinimumHeight((int) (150 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    ...
    // ====== NumberPicker ======
    if (className.equals("android.widget.NumberPicker")) {
      try {
        view.setMinimumHeight((int) (100 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }

    // ====== CalendarView ======
    if (className.equals("android.widget.CalendarView")) {
      try {
        view.setMinimumHeight((int) (200 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    ...
    // ====== TableLayout ======
    if (className.equals("android.widget.TableLayout")) {
      try {
        view.setMinimumHeight((int) (100 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    ...
    // ====== MaterialDivider ======
    if (className.equals("com.google.android.material.divider.MaterialDivider")) {
      try {
        view.setMinimumHeight((int) (1 * context.getResources().getDisplayMetrics().density));
      } catch (Throwable ignored) {
      }
    }
  }
  ...
  private void fillViewPager2(ViewPager2 view) {
    view.setAdapter(
        ...
        new BaseExpandableListAdapter() {
          ...
          public View getGroupView(
            ...
            ((TextView) view.findViewById(android.R.id.text1))
                .setText(context.getString(R.string.group_) + (groupPosition + 1));
            return view;
          }
          ...
          public View getChildView(
            ...
            ((TextView) view2.findViewById(android.R.id.text1))
                .setText(context.getString(R.string.item_) + (childPosition + 1));
            ((TextView) view2.findViewById(16908309))
                .setText(context.getString(R.string.item_) + (childPosition + 1));
            return view2;
          }
  ...
  @SuppressLint("ResourceType")
  private void fillRecyclerView(RecyclerView view) {
    List<String> items = new ArrayList<>();
    for (int i = 0; i < 30; i++) {
      items.add("Item " + i);
    }
      ...
      try {
        return (View)
            Class.forName(elementName)
                .getConstructor(Context.class, AttributeSet.class, Integer.TYPE)
                .newInstance(
                    context,
                    null,
                    Integer.valueOf(
                        ((Integer)
                                R.attr
                                    ...
                                    .getField(
                                        "Android_"
                                            + baseStyle
                                                .substring("@android:style/".length())
                                                .replace(".", "_"))
                                    .get(null))
                            .intValue()));
      } catch (Throwable th) {
        ...
        return (View)
            Class.forName(elementName)
                ...
                .newInstance(
                    ...
                    R.attr
                        .class
                        .getField(baseStyle.substring("?android:attr/".length()))
                        .get(null));
      } catch (Throwable th) {
        th.printStackTrace();
      }
  ...
  private PropertyObject inflateLayoutParams(Node node, ViewGroup parent) {
    ...
    try {
      ...
      if (parentClassName.equals("com.google.android.material.textfield.TextInputLayout")
          || parentClassName.equals("com.google.android.material.chip.ChipGroup")
          || parentClassName.equals("android.widget.RadioGroup")
          || parentClassName.equals("android.widget.TableRow")
          || parentClassName.equals(
              "com.google.android.material.button.MaterialButtonToggleGroup")) {
        parentClassName = "android.widget.LinearLayout";
      }

      if (parentClassName.equals("com.google.android.material.card.MaterialCardView")
          || parentClassName.equals("androidx.coordinatorlayout.widget.CoordinatorLayout")
          || parentClassName.equals("com.google.android.material.appbar.AppBarLayout")
          || parentClassName.equals("com.google.android.material.appbar.CollapsingToolbarLayout")
          || parentClassName.equals("androidx.drawerlayout.widget.DrawerLayout")
          || parentClassName.equals(
              "com.google.android.material.bottomsheet.BottomSheetBehavior")) {
        parentClassName = "android.widget.FrameLayout";
      }

      Class<?> layoutParamsClass = Class.forName(parentClassName + "$LayoutParams");
      try {
        layoutParams =
            (ViewGroup.LayoutParams)
                layoutParamsClass.getConstructor(Integer.TYPE, Integer.TYPE).newInstance(-2, -2);
      } catch (NoSuchMethodException e) {
        layoutParams =
            (ViewGroup.LayoutParams)
                layoutParamsClass
                    .getConstructor(ViewGroup.LayoutParams.class)
                    .newInstance(new ViewGroup.LayoutParams(-1, -1));
      }
  ...
  private void inflateAttributes(
      PropertyObject obj, Node node, @NonNull XmlLayoutProperties.PropertySpec[] properties) {
    int min;
    for (XmlLayoutProperties.PropertySpec property : properties) {
      if (obj.hasProperty(property)) {
        ...
        if (editMode
            ...
            && ((property == XmlLayoutProperties.LAYOUT_WIDTH
                    || property == XmlLayoutProperties.LAYOUT_HEIGHT)
                && (Integer) value >= 0
                && (Integer) value
                    < (min =
                        (int) (10.0f * this.context.getResources().getDisplayMetrics().density)))) {
          value = min;
        }
  ...
  @Nullable
  private Object getSystemStyleAttributeValue(
      Node node, XmlLayoutProperties.PropertySpec property) {
    try {
  ...
  @Nullable
  private Object getDirectPropertyAttributeValue(
      Node node, @NonNull XmlLayoutProperties.PropertySpec property) {
    switch (property.type) {
      case Bool:
    ...
    if (value != null && value.startsWith("@android:drawable/")) {
      try {
        return ResourcesCompat.getDrawable(
            ...
            Utils.getAndroidResourceID(android.R.drawable.class.getName(), "@android:drawable/"),
            context.getTheme());
      } catch (Throwable th) {
        th.printStackTrace();
      }
  ...
  @Nullable
  private Enum<?> getEnumConstantAttributeValue(
      Node node, XmlLayoutProperties.PropertySpec property) {
    try {
      String value = getResourcePropertyValue(node, property);
      if (value != null) {
        ...
        for (Field field : arr$) {
          ...
          if ((field.getModifiers() & 8) != 0
              && fieldName.replace("_", "").equals(value.toUpperCase())) {
  ...
  @Nullable
  private Integer getIntConstantAttributeValue(
      Node node, XmlLayoutProperties.PropertySpec property) {
    String value = getResourcePropertyValue(node, property);
    if (value == null) {
      return null;
  ...
  @Nullable
  private Integer getIntConstantAttributeValue(
      String value, @NonNull XmlLayoutProperties.PropertySpec property) {
    ...
    for (Field field : arr$) {
      String fieldName = field.getName();
      if ((field.getModifiers() & 8) != 0
          && fieldName.startsWith(property.constantFieldPrefix)
          && fieldName
              .substring(property.constantFieldPrefix.length())
              .replace("_", "")
      ...
      try {
        if (value.charAt(0) == '#') {
          ...
          return ResourcesCompat.getColor(
              context.getResources(),
              Utils.getAndroidResourceID(android.R.color.class.getName(), value),
              context.getTheme());
    ...
    if (value != null) {
      try {
        ...
        if (value.endsWith("dp")) {
          ...
          return context
              ...
              .getDimensionPixelSize(
                  Utils.getAndroidResourceID(android.R.dimen.class.getName(), "@android:dimen/"));
        ...
        Log.e(
            ...
            "\n"
                + "Line Number: "
                + node.getUserData(PositionalXMLReader.LINE)
                + "\n"
                + "Column Number: "
                + node.getUserData(PositionalXMLReader.COLUMN)
                + "\n"
                + node.getNodeName()
                + "\n"
                + property.attrName
  ...
  @NonNull
  @Contract("_, _ -> new")
  private AttributeValue getPropertyValue(
      @NonNull Node node, @NonNull XmlLayoutProperties.PropertySpec property) {
    String value;
