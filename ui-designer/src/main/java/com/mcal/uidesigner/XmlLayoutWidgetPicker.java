...
public class XmlLayoutWidgetPicker {
    ...
    public static void selectRootView(Activity activity, String title, ValueRunnable<
                    NewWidget> ok) {
    ...
    private static void selectView(
        ...
        final List<List<Widget>> widgets = getWidgetsToShow(onlyLayouts, onlyRootViews, activity
                instanceof AppWizardDesignActivity);
                    ...
                    public Dialog buildDialog(Activity activity) {
                        ...
                        listView.setOnChildClickListener(
                                (parent, v, groupPosition, childPosition, id) -> {
                                    alertDialog.dismiss();
                                    Widget widget = (Widget) ((List<
                                                            ?>) widgets.get(groupPosition)).get(childPosition);
                                    Map<
                                            String,
                                            String> attributes = new HashMap<>(widget.getAttributes());
                                    if (onlyRootViews) {
