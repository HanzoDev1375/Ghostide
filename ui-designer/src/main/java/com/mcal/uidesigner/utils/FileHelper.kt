...
object FileHelper {
  ...
  @JvmStatic
  fun readFile(file: File) = FileInputStream(file).readBytes().toString(StandardCharsets.UTF_8)

  @JvmStatic
  fun readFile(inputStream: InputStream) = inputStream.readBytes().toString(StandardCharsets.UTF_8)
