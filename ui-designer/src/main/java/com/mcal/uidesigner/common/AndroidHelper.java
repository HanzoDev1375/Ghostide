...
public class AndroidHelper {
    ...
    if (isAndroidTV(activity)) {
      ...
      View av =
          activity
              ...
              .getDecorView()
              .findViewById(
                  activity.getResources().getIdentifier("action_bar_container", "id", "android"));
      if (av != null) {
  ...
  public static void makeToolbarFocusable(@NonNull AppCompatActivity activity) {
    View tv =
        activity.findViewById(activity.getResources().getIdentifier("action_bar", "id", "android"));
    ...
    try {
      Method setHasEmbeddedTabsMethod =
          activity
              .getSupportActionBar()
              .getClass()
              .getDeclaredMethod("setHasEmbeddedTabs", Boolean.TYPE);
              ...
              try {
                ...
                if (spinner != null) {
                  ...
                  Class.forName("android.view.View$ListenerInfo")
                      ...
                      .set(method_GetListenerInfo.invoke(spinner), onClickListener);
                }
              } catch (Throwable t) {
                t.printStackTrace();
              }
  ...
  public static void correctCodeFontSize(@NonNull TextView textView) {
    textView.setTextSize(
        ((float) correctCodeFontSize(textView.getContext(), (int) textView.getTextSize()))
            / textView.getContext().getResources().getDisplayMetrics().scaledDensity);
  }
