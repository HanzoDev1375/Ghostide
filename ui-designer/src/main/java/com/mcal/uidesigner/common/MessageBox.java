...
public abstract class MessageBox {
  ...
  public static void showInfo(
      Activity activity, String title, String message, Runnable ok, Runnable cancelled) {
  ...
  public static void queryYesNo(
    ...
    queryYesNo(
        ...
        activity.getResources().getString(message) + listText,
  ...
  public static void queryYesNo(
      Activity activity, int title, int message, Runnable yes, Runnable no) {
    queryYesNo(
        activity,
        activity.getResources().getString(title),
  ...
  public static void queryYesNo(
      Activity activity, String title, String message, Runnable yes, Runnable no) {
  ...
  public static void queryKeyStroke(
      Activity activity,
      final String title,
      final String message,
      final KeyStroke oldStroke,
      final ValueRunnable<KeyStroke> ok) {
    showDialog(
        activity,
        new MessageBox() {
          @Override
          public Dialog buildDialog(final Activity activity2) {
            ...
            input.setOnEditorActionListener(
                (v, actionId, event) -> {
                  if (actionId == 6) {
                    ((InputMethodManager) activity2.getSystemService(Context.INPUT_METHOD_SERVICE))
            ...
            builder.setCancelable(true);
            builder.setPositiveButton(
                activity2.getResources().getString(R.string.dialog_ok),
                (dialog, id) -> {
                  ((InputMethodManager) activity2.getSystemService(Context.INPUT_METHOD_SERVICE))
                      .hideSoftInputFromWindow(input.getWindowToken(), 0);
                  ok.run(input.getKeyStroke());
            ...
            builder.setNegativeButton(
                activity2.getResources().getString(R.string.dialog_cancel),
                (dialog, id) -> {
                  ((InputMethodManager) activity2.getSystemService(Context.INPUT_METHOD_SERVICE))
                      .hideSoftInputFromWindow(input.getWindowToken(), 0);
                  dialog.cancel();
  ...
  public static void queryFromList(
      Activity activity, String title, List<String> values, ValueRunnable<String> ok) {
    queryFromList(activity, title, values, true, ok);
  }

  private static void queryFromList(
      Activity activity,
      final String title,
      final List<String> values,
      final boolean cancelable,
      final ValueRunnable<String> ok) {
    showDialog(
        activity,
        new MessageBox() {
          @Override
  ...
  public static void querySingleChoiceFromList(
      Activity activity,
      final String title,
      final List<String> values,
        ...
        new MessageBox() {
          ...
          public Dialog buildDialog(Activity activity2) {
            ...
            builder.setSingleChoiceItems(
                values.toArray(new CharSequence[0]), values.indexOf(selectedValue), null);
            builder.setPositiveButton(
                activity2.getResources().getString(R.string.dialog_ok),
                (dialog, which) -> {
                  dialog.dismiss();
  ...
  public static void queryMultipleChoiceFromList(
      Activity activity,
      final String title,
      final List<String> values,
      final List<Boolean> selectedValues,
      final ValueRunnable<List<Integer>> ok) {
    showDialog(
        activity,
        new MessageBox() {
          @Override
  ...
  public static void queryIndexFromList(
      Activity activity,
      final String title,
      final List<String> values,
      final ValueRunnable<Integer> ok) {
    showDialog(
        activity,
        new MessageBox() {
          @Override
  ...
  public static void queryIndexFromList(
      ...
      final ValueRunnable<Integer> click,
      final Runnable ok) {
    showDialog(
        activity,
        new MessageBox() {
        ...
        new MessageBox() {
          ...
          public Dialog buildDialog(final Activity activity2) {
            ...
            final EditText input =
                new AppCompatEditText(activity2) {
                  @Override
                  ...
                  public boolean onKeyUp(int keyCode, KeyEvent event) {
                    ...
                    ((InputMethodManager) activity2.getSystemService("input_method"))
  ...
  public static void queryPassword(
      ...
      String title,
      String message,
      ValueRunnable<String> ok,
      Runnable cancelled) {
    queryText(activity, title, message, null, "", true, ok, cancelled, null);
  }

  public static void queryPassword(
      Activity activity, String title, String message, ValueRunnable<String> ok) {
  ...
  public static void queryText(
      Activity activity, int title, int message, String oldText, ValueRunnable<String> ok) {
    queryText(
        activity,
        activity.getResources().getString(title),
        activity.getResources().getString(message),
  ...
  public static void queryText(
      Activity activity, String title, String message, String oldText, ValueRunnable<String> ok) {
  ...
  public static void queryMultipleValues(
      Activity activity,
      String title,
    ...
    List<String> selectedValues =
        value == null ? new ArrayList<>() : Arrays.asList(value.split("\\|"));
    for (String v : values) {
      isSelected.add(selectedValues.contains(v));
    }
    queryMultipleChoiceFromList(
        activity,
        title,
        displayValues,
        isSelected,
