...
public class Cursor {
   ...
   *
   * <p>Especially when the editor user want to set a new cursor position after scrolling long time
   *
   ...
   */
  void afterInsert(
      int startLine, int startColumn, int endLine, int endColumn, CharSequence insertedContent) {
   ...
   */
  void afterDelete(
      int startLine, int startColumn, int endLine, int endColumn, CharSequence deletedContent) {
