...
public class SymbolPairMatch {
  ...
  public static class Replacement {
    ...
    /**
     * The entered character will be replaced to {@param text} and the new cursor position will be
     * {@param selection} The value of {@param selection} maybe 0 to {@param text}.length()
     */
    ...
    public interface IReplacement {
      /**
       * The method will be called to decide whether to perform the replace or not. It maybe same as
       * vscode language-configuration Autoclosing 'notIn' also see <a
       ...
       *
       * @param currentLine The currently line edit in the editor,quick analysis it to decide
       *     whether to replaced
      ...
      /**
       * when before the replaced and select a range,surrounds the selected content with return pair
       * if return pair not null. If not implemented,always return null also see <a
