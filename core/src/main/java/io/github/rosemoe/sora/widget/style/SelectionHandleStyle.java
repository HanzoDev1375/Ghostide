...
public interface SelectionHandleStyle {
   ...
   * @param color The color of handle configured in {@link
   *     io.github.rosemoe.sora.widget.EditorColorScheme}
  ...
  class HandleDescriptor {
    ...
    /**
     * The alignment of the handle (of the x coordinate) For example, you can draw handle with align
     * right of the x when you draw the left handle
     *
     * @see #ALIGN_CENTER
     * @see #ALIGN_LEFT
     * @see #ALIGN_RIGHT
