...
public class ContentLine implements CharSequence, GetChars {
   ...
   *
   * <p>If {@code s} is {@code null}, then the four characters {@code "null"} are inserted into this
   * sequence.
   *
   ...
   * </ul>
   *
   * <p>The {@code dstOffset} argument must be greater than or equal to {@code 0}, and less than or
   ...
   * the length of s.
   *
   * <p>If {@code s} is {@code null}, then this method inserts characters as if the s parameter was
   * a sequence containing the four characters {@code "null"}.
   *
   ...
   * sequence if no such character exists. If {@code start} is equal to {@code end}, no changes are
   * made.
   *
