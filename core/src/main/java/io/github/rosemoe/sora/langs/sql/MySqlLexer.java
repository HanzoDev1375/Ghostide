// Generated from /storage/emulated/0/apk/MySqlLexer.g4 by ANTLR 4.13.1
...
public class MySqlLexer extends Lexer {
	...
	public static final int
		SPACE=1, SPEC_MYSQL_COMMENT=2, COMMENT_INPUT=3, ADD=4, ALL=5, ALTER=6, 
		ALWAYS=7, ANALYZE=8, AND=9, ARRAY=10, AS=11, ASC=12, ATTRIBUTE=13, BEFORE=14, 
		BETWEEN=15, BOTH=16, BUCKETS=17, BY=18, CALL=19, CASCADE=20, CASE=21, 
		CAST=22, CHANGE=23, CHARACTER=24, CHECK=25, COLLATE=26, COLUMN=27, CONDITION=28, 
		CONSTRAINT=29, CONTINUE=30, CONVERT=31, CREATE=32, CROSS=33, CURRENT=34, 
		CURRENT_ROLE=35, CURRENT_USER=36, CURSOR=37, DATABASE=38, DATABASES=39, 
		DECLARE=40, DEFAULT=41, DELAYED=42, DELETE=43, DESC=44, DESCRIBE=45, DETERMINISTIC=46, 
		DIAGNOSTICS=47, DISTINCT=48, DISTINCTROW=49, DROP=50, EACH=51, ELSE=52, 
		ELSEIF=53, EMPTY=54, ENCLOSED=55, ENFORCED=56, ESCAPED=57, EXCEPT=58, 
		EXISTS=59, EXIT=60, EXPLAIN=61, FALSE=62, FETCH=63, FOR=64, FORCE=65, 
		FOREIGN=66, FROM=67, FULLTEXT=68, GENERATED=69, GET=70, GRANT=71, GROUP=72, 
		HAVING=73, HIGH_PRIORITY=74, HISTOGRAM=75, IF=76, IGNORE=77, IGNORED=78, 
		IN=79, INDEX=80, INFILE=81, INNER=82, INOUT=83, INSERT=84, INTERVAL=85, 
		INTO=86, IS=87, ITERATE=88, JOIN=89, KEY=90, KEYS=91, KILL=92, LATERAL=93, 
		LEADING=94, LEAVE=95, LEFT=96, LIKE=97, LIMIT=98, LINEAR=99, LINES=100, 
		LOAD=101, LOCK=102, LOCKED=103, LOOP=104, LOW_PRIORITY=105, MASTER_BIND=106, 
		MASTER_SSL_VERIFY_SERVER_CERT=107, MATCH=108, MAXVALUE=109, MINVALUE=110, 
		MODIFIES=111, NATURAL=112, NOT=113, NO_WRITE_TO_BINLOG=114, NULL_LITERAL=115, 
		NUMBER=116, ON=117, OPTIMIZE=118, OPTION=119, OPTIONAL=120, OPTIONALLY=121, 
		OR=122, ORDER=123, OUT=124, OUTER=125, OUTFILE=126, OVER=127, PARTITION=128, 
		PRIMARY=129, PROCEDURE=130, PURGE=131, RANGE=132, READ=133, READS=134, 
		REFERENCES=135, REGEXP=136, RELEASE=137, RENAME=138, REPEAT=139, REPLACE=140, 
		REQUIRE=141, RESIGNAL=142, RESTRICT=143, RETAIN=144, RETURN=145, REVOKE=146, 
		RIGHT=147, RLIKE=148, SCHEMA=149, SCHEMAS=150, SELECT=151, SET=152, SEPARATOR=153, 
		SHOW=154, SIGNAL=155, SKIP_=156, SKIP_QUERY_REWRITE=157, SPATIAL=158, 
		...
		ADMIN=696, APPLICATION_PASSWORD_ADMIN=697, AUDIT_ABORT_EXEMPT=698, AUDIT_ADMIN=699, 
		AUTHENTICATION_POLICY_ADMIN=700, BACKUP_ADMIN=701, BINLOG_ADMIN=702, BINLOG_ENCRYPTION_ADMIN=703, 
		CLONE_ADMIN=704, CONNECTION_ADMIN=705, ENCRYPTION_KEY_ADMIN=706, EXECUTE=707, 
		FILE=708, FIREWALL_ADMIN=709, FIREWALL_EXEMPT=710, FIREWALL_USER=711, 
		FLUSH_OPTIMIZER_COSTS=712, FLUSH_STATUS=713, FLUSH_TABLES=714, FLUSH_USER_RESOURCES=715, 
		GROUP_REPLICATION_ADMIN=716, INNODB_REDO_LOG_ARCHIVE=717, INNODB_REDO_LOG_ENABLE=718, 
		INVOKE=719, LAMBDA=720, NDB_STORED_USER=721, PASSWORDLESS_USER_ADMIN=722, 
		PERSIST_RO_VARIABLES_ADMIN=723, PRIVILEGES=724, PROCESS=725, RELOAD=726, 
		REPLICATION_APPLIER=727, REPLICATION_SLAVE_ADMIN=728, RESOURCE_GROUP_ADMIN=729, 
		RESOURCE_GROUP_USER=730, ROLE_ADMIN=731, ROUTINE=732, S3=733, SERVICE_CONNECTION_ADMIN=734, 
		SESSION_VARIABLES_ADMIN=735, SET_USER_ID=736, SHOW_ROUTINE=737, SHUTDOWN=738, 
		SUPER=739, SYSTEM_VARIABLES_ADMIN=740, TABLES=741, TABLE_ENCRYPTION_ADMIN=742, 
		VERSION_TOKEN_ADMIN=743, XA_RECOVER_ADMIN=744, ARMSCII8=745, ASCII=746, 
		BIG5=747, CP1250=748, CP1251=749, CP1256=750, CP1257=751, CP850=752, CP852=753, 
		CP866=754, CP932=755, DEC8=756, EUCJPMS=757, EUCKR=758, GB18030=759, GB2312=760, 
		GBK=761, GEOSTD8=762, GREEK=763, HEBREW=764, HP8=765, KEYBCS2=766, KOI8R=767, 
		KOI8U=768, LATIN1=769, LATIN2=770, LATIN5=771, LATIN7=772, MACCE=773, 
		MACROMAN=774, SJIS=775, SWE7=776, TIS620=777, UCS2=778, UJIS=779, UTF16=780, 
		UTF16LE=781, UTF32=782, UTF8=783, UTF8MB3=784, UTF8MB4=785, ARCHIVE=786, 
		BLACKHOLE=787, CSV=788, FEDERATED=789, INNODB=790, MEMORY=791, MRG_MYISAM=792, 
		MYISAM=793, NDB=794, NDBCLUSTER=795, PERFORMANCE_SCHEMA=796, TOKUDB=797, 
		REPEATABLE=798, COMMITTED=799, UNCOMMITTED=800, SERIALIZABLE=801, GEOMETRYCOLLECTION=802, 
		GEOMCOLLECTION=803, GEOMETRY=804, LINESTRING=805, MULTILINESTRING=806, 
		MULTIPOINT=807, MULTIPOLYGON=808, POINT=809, POLYGON=810, ABS=811, ACOS=812, 
		ADDDATE=813, ADDTIME=814, AES_DECRYPT=815, AES_ENCRYPT=816, AREA=817, 
		ASBINARY=818, ASIN=819, ASTEXT=820, ASWKB=821, ASWKT=822, ASYMMETRIC_DECRYPT=823, 
		...
		RANDOM=990, RANDOM_BYTES=991, RELEASE_LOCK=992, REVERSE=993, ROUND=994, 
		ROW_COUNT=995, RPAD=996, RTRIM=997, SEC_TO_TIME=998, SECONDARY_ENGINE_ATTRIBUTE=999, 
		...
		DECIMAL_LITERAL=1148, HEXADECIMAL_LITERAL=1149, HEXCOLOR=1150, REAL_LITERAL=1151, 
		NULL_SPEC_LITERAL=1152, BIT_STRING=1153, STRING_CHARSET_NAME=1154, DOT_ID=1155, 
		ID=1156, REVERSE_QUOTE_ID=1157, HOST_IP_ADDRESS=1158, LOCAL_ID=1159, GLOBAL_ID=1160, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SPACE", "SPEC_MYSQL_COMMENT", "COMMENT_INPUT", "ADD", "ALL", "ALTER", 
			"ALWAYS", "ANALYZE", "AND", "ARRAY", "AS", "ASC", "ATTRIBUTE", "BEFORE", 
			...
			"STRING_LITERAL", "DECIMAL_LITERAL", "HEXADECIMAL_LITERAL", "HEXCOLOR", 
			"REAL_LITERAL", "NULL_SPEC_LITERAL", "BIT_STRING", "STRING_CHARSET_NAME", 
			"DOT_ID", "ID", "REVERSE_QUOTE_ID", "HOST_IP_ADDRESS", "LOCAL_ID", "GLOBAL_ID", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, "'ADD'", "'ALL'", "'ALTER'", "'ALWAYS'", "'ANALYZE'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "SPACE", "SPEC_MYSQL_COMMENT", "COMMENT_INPUT", "ADD", "ALL", "ALTER", 
			"ALWAYS", "ANALYZE", "AND", "ARRAY", "AS", "ASC", "ATTRIBUTE", "BEFORE", 
			"BETWEEN", "BOTH", "BUCKETS", "BY", "CALL", "CASCADE", "CASE", "CAST", 
			"CHANGE", "CHARACTER", "CHECK", "COLLATE", "COLUMN", "CONDITION", "CONSTRAINT", 
			"CONTINUE", "CONVERT", "CREATE", "CROSS", "CURRENT", "CURRENT_ROLE", 
	...
	private static final String _serializedATNSegment1 =
		...
		"\u0000QQqq\b\u0000GGKKMMTTggkkmmtt\u0003\u000009AFaf\u0007\u0000$$..0"+
		"9AZ__az\u0080\u8000\uffff\u0002\u0000++--\u0006\u0000$$09AZ__az\u0080"+
		"\u8000\uffff\u0005\u0000$$AZ__az\u0080\u8000\uffff\u0002\u0000\"\"\\\\"+
		"\u0002\u0000\'\'\\\\\u0001\u0000``\u0001\u000009\u0001\u000001\u0002\u0000"+
		"..09\u0003\u00000:AFaf\u35b2\u0000\u0001\u0001\u0000\u0000\u0000\u0000"+
