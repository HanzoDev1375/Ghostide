      ...
      int res = -1;
      {
        ...
        for (int i = regionStart; i < regionEnd; i++) {
          if (chars[i] == '\t') {
            ...
            if (lastStart != i) {
              int idx =
                  mPaint.findOffsetByRunAdvance(mText, lastStart, i, advance - currentPosition);
              currentPosition +=
        ...
        if (res == -1) {
          int idx =
              mPaint.findOffsetByRunAdvance(mText, lastStart, regionEnd, advance - currentPosition);
