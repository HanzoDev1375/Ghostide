...
public class SchemeDarcula extends EditorColorScheme {
    ...
    public void applyDefault() {
        super.applyDefault();
        setColor(ANNOTATION, Color.parseColor("#FF00CBF4"));
        setColor(FUNCTION_NAME, Color.parseColor("#FF00F462"));
        setColor(IDENTIFIER_NAME, Color.parseColor("#fff00000"));
        setColor(IDENTIFIER_VAR, Color.parseColor("#FFF0F400"));
        setColor(LITERAL, Color.parseColor("#FFF47200"));
        setColor(OPERATOR, Color.parseColor("#FFF0c900"));
        setColor(COMMENT, Color.parseColor("#ff909090"));
        setColor(KEYWORD, Color.parseColor("#FFEB01DC"));
        setColor(WHOLE_BACKGROUND, 0);
        setColor(TEXT_NORMAL, Color.parseColor("#FFEB017A"));
