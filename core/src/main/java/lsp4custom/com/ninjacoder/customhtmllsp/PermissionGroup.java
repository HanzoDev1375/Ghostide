...
import lsp4custom.com.ninjacoder.customhtmllsp.ManifestPermissionConstants;
...
public enum PermissionGroup {
  ...
  BIND_CARRIER_MESSAGING_CLIENT_SERVICE(
      ManifestPermissionConstants.BIND_CARRIER_MESSAGING_CLIENT_SERVICE),
  ...
  BIND_NOTIFICATION_LISTENER_SERVICE(
      ManifestPermissionConstants.BIND_NOTIFICATION_LISTENER_SERVICE),
  ...
  LAUNCH_MULTI_PANE_SETTINGS_DEEP_LINK(
      ManifestPermissionConstants.LAUNCH_MULTI_PANE_SETTINGS_DEEP_LINK),
  ...
  REQUEST_COMPANION_PROFILE_APP_STREAMING(
      ManifestPermissionConstants.REQUEST_COMPANION_PROFILE_APP_STREAMING),
  REQUEST_COMPANION_PROFILE_AUTOMOTIVE_PROJECTION(
      ManifestPermissionConstants.REQUEST_COMPANION_PROFILE_AUTOMOTIVE_PROJECTION),
  REQUEST_COMPANION_PROFILE_COMPUTER(
      ManifestPermissionConstants.REQUEST_COMPANION_PROFILE_COMPUTER),
  REQUEST_COMPANION_PROFILE_WATCH(ManifestPermissionConstants.REQUEST_COMPANION_PROFILE_WATCH),
  REQUEST_COMPANION_RUN_IN_BACKGROUND(
      ManifestPermissionConstants.REQUEST_COMPANION_RUN_IN_BACKGROUND),
  REQUEST_COMPANION_SELF_MANAGED(ManifestPermissionConstants.REQUEST_COMPANION_SELF_MANAGED),
  REQUEST_COMPANION_START_FOREGROUND_SERVICES_FROM_BACKGROUND(
      ManifestPermissionConstants.REQUEST_COMPANION_START_FOREGROUND_SERVICES_FROM_BACKGROUND),
  REQUEST_COMPANION_USE_DATA_IN_BACKGROUND(
      ManifestPermissionConstants.REQUEST_COMPANION_USE_DATA_IN_BACKGROUND),
  REQUEST_DELETE_PACKAGES(ManifestPermissionConstants.REQUEST_DELETE_PACKAGES),
  REQUEST_IGNORE_BATTERY_OPTIMIZATIONS(
      ManifestPermissionConstants.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS),
  REQUEST_INSTALL_PACKAGES(ManifestPermissionConstants.REQUEST_INSTALL_PACKAGES),
  REQUEST_OBSERVE_COMPANION_DEVICE_PRESENCE(
      ManifestPermissionConstants.REQUEST_OBSERVE_COMPANION_DEVICE_PRESENCE),
  ...
  START_FOREGROUND_SERVICES_FROM_BACKGROUND(
      ManifestPermissionConstants.START_FOREGROUND_SERVICES_FROM_BACKGROUND),
  ...
  SUBSCRIBE_TO_KEYGUARD_LOCKED_STATE(
      ManifestPermissionConstants.SUBSCRIBE_TO_KEYGUARD_LOCKED_STATE),
  ...
  UPDATE_PACKAGES_WITHOUT_USER_ACTION(
      ManifestPermissionConstants.UPDATE_PACKAGES_WITHOUT_USER_ACTION),
  ...
  USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER(
      ManifestPermissionConstants.USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER),
  ...
  PermissionGroup(String constant) {
