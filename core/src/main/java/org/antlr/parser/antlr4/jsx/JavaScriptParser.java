...
public class JavaScriptParser extends JavaScriptParserBase {
	...
	public static final int
		...
		Await=105, Implements=106, StrictLet=107, NonStrictLet=108, Private=109, 
		Public=110, Interface=111, Package=112, Protected=113, Static=114, Yield=115, 
		Identifier=116, StringLiteral=117, LinkLiteral=118, BackTick=119, WhiteSpaces=120, 
		LineTerminator=121, JsxComment=122, MultiLineComment=123, SingleLineComment=124, 
		RegularExpressionLiteral=125, HtmlComment=126, CDataComment=127, UnexpectedCharacter=128, 
		CDATA=129, TemplateStringStartExpression=130, TemplateStringAtom=131, 
		JsxOpeningElementBegin=132, JsxOpeningElementEnd=133, JsxOpeningElementSlashEnd=134, 
		JsxAssign=135, JsxOpeningElementOpenBrace=136, JsxOpeningElementId=137, 
		JsxOpeningElementWhiteSpaces=138, JsxOpeningElementLineTerminator=139, 
		JsxOpeningElementMultiLineComment=140, JsxOpeningElementSingleLineComment=141, 
		JsxAttributeValue=142, HtmlChardata=143, JsxChildrenOpeningElementBegin=144, 
		JsxChildrenClosingElementSlashBegin=145, JsxChildrenOpenBrace=146, JsxClosingElementEnd=147, 
		JsxClosingElementId=148, JsxClosingElementLineTerminator=149, JsxClosingElementWhiteSpaces=150;
	public static final int
		...
		RULE_jsxElements = 58, RULE_jsxElementBegin = 59, RULE_jsxElement = 60, 
		RULE_jsxSelfClosingElement = 61, RULE_jsxOpeningElement = 62, RULE_jsxClosingElement = 63, 
		RULE_jsxChildren = 64, RULE_jsxSelfClosingElementName = 65, RULE_jsxOpeningElementName = 66, 
		RULE_jsxClosingElementName = 67, RULE_jsxAttributes = 68, RULE_jsxSpreadAttribute = 69, 
		RULE_jsxAttribute = 70, RULE_jsxAttributeName = 71, RULE_jsxAttributeValue = 72, 
		RULE_assignable = 73, RULE_objectLiteral = 74, RULE_openBrace = 75, RULE_objectExpressionSequence = 76, 
		RULE_anoymousFunction = 77, RULE_arrowFunctionParameters = 78, RULE_arrowFunctionBody = 79, 
		RULE_assignmentOperator = 80, RULE_literal = 81, RULE_templateStringLiteral = 82, 
		RULE_templateStringAtom = 83, RULE_numericLiteral = 84, RULE_bigintLiteral = 85, 
		RULE_getter = 86, RULE_setter = 87, RULE_identifierName = 88, RULE_identifier = 89, 
		RULE_reservedWord = 90, RULE_keyword = 91, RULE_let_ = 92, RULE_eos = 93;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LinkLiteral", "BackTick", "WhiteSpaces", "LineTerminator", "JsxComment", 
			"MultiLineComment", "SingleLineComment", "RegularExpressionLiteral", 
			"HtmlComment", "CDataComment", "UnexpectedCharacter", "CDATA", "TemplateStringStartExpression", 
			"TemplateStringAtom", "JsxOpeningElementBegin", "JsxOpeningElementEnd", 
	...
	public final IterationStatementContext iterationStatement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -144115188071710548L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 2357655927150118031L) != 0) || _la==JsxOpeningElementBegin || _la==JsxChildrenOpeningElementBegin) {
					{
					setState(368);
					expressionSequence();
					}
	...
	public final CatchProductionContext catchProduction() throws RecognitionException {
		...
		try {
			...
			if (_la==OpenParen) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==OpenBracket || _la==OpenBrace || ((((_la - 104)) & ~0x3f) == 0 && ((1L << (_la - 104)) & 4113L) != 0)) {
					{
					setState(505);
					assignable();
					}
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16520L) != 0) || ((((_la - 104)) & ~0x3f) == 0 && ((1L << (_la - 104)) & 4113L) != 0)) {
				{
				setState(528);
				formalParameterList();
				}
	...
	public final JsxChildrenContext jsxChildren() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==JsxElementBegin || _la==OpenBrace || ((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & 20497L) != 0)) {
				{
				{
				setState(962);
				_errHandler.sync(this);
	...
	public final ObjectLiteralContext objectLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -144115188067516244L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 2359886204742139903L) != 0) || _la==JsxOpeningElementBegin || _la==JsxChildrenOpeningElementBegin) {
				{
				setState(1015);
				propertyAssignment();
				setState(1020);
