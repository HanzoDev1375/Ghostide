...
import static ir.ninjacoder.ghostide.core.tasks.FileWatcher.OnFileChangeListener;
 ...
 * @author EUP
 */
public class FileWatcherService extends Service implements OnFileChangeListener {
