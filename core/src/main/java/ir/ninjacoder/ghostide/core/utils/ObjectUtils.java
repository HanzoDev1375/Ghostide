...
import ir.ninjacoder.ghostide.core.marco.WavyUnderlineSpan;
import ir.ninjacoder.ghostide.core.model.ObjectClassName;
import ir.ninjacoder.ghostide.core.utils.FileUtil;
import ir.ninjacoder.ghostide.core.widget.ExrtaFab;

public class ObjectUtils {
  public static int colorPrimary = R.attr.colorPrimary;
  public static int colorOnPrimary = R.attr.colorOnPrimary;
  public static int colorPrimaryContainer = R.attr.colorPrimaryContainer;
  public static int colorOnPrimaryContainer = R.attr.colorOnPrimaryContainer;
  public static int colorPrimaryFixed = R.attr.colorPrimaryFixed;
  public static int colorPrimaryFixedDim = R.attr.colorPrimaryFixedDim;
  public static int colorOnPrimaryFixed = R.attr.colorOnPrimaryFixed;
  public static int colorOnPrimaryFixedVariant = R.attr.colorOnPrimaryFixedVariant;
  public static int colorSecondary = R.attr.colorSecondary;
  public static int colorOnSecondary = R.attr.colorOnSecondary;
  public static int colorSecondaryContainer = R.attr.colorSecondaryContainer;
  public static int colorOnSecondaryContainer = R.attr.colorOnSecondaryContainer;
  public static int colorSecondaryFixed = R.attr.colorSecondaryFixed;
  public static int colorSecondaryFixedDim = R.attr.colorSecondaryFixedDim;
  public static int colorOnSecondaryFixed = R.attr.colorOnSecondaryFixed;
  public static int colorOnSecondaryFixedVariant = R.attr.colorOnSecondaryFixedVariant;
  public static int colorTertiary = R.attr.colorTertiary;
  public static int colorOnTertiary = R.attr.colorOnTertiary;
  public static int colorTertiaryContainer = R.attr.colorTertiaryContainer;
  public static int colorOnTertiaryContainer = R.attr.colorOnTertiaryContainer;
  public static int colorTertiaryFixed = R.attr.colorTertiaryFixed;
  public static int colorTertiaryFixedDim = R.attr.colorTertiaryFixedDim;
  public static int colorOnTertiaryFixed = R.attr.colorOnTertiaryFixed;
  public static int colorOnTertiaryFixedVariant = R.attr.colorOnTertiaryFixedVariant;
  public static int colorError = R.attr.colorError;
  public static int colorOnError = R.attr.colorOnError;
  public static int colorErrorContainer = R.attr.colorErrorContainer;
  public static int colorOnErrorContainer = R.attr.colorOnErrorContainer;
  public static int colorBackground = android.R.attr.colorBackground;
  public static int colorOnBackground = R.attr.colorOnBackground;
  public static int colorSurface = R.attr.colorSurface;
  public static int colorOnSurface = R.attr.colorOnSurface;
  public static int colorSurfaceVariant = R.attr.colorSurfaceVariant;
  public static int colorOnSurfaceVariant = R.attr.colorOnSurfaceVariant;
  public static int colorOutline = R.attr.colorOutline;
  public static int colorOutlineVariant = R.attr.colorOutlineVariant;
  public static int colorSurfaceInverse = R.attr.colorSurfaceInverse;
  public static int colorOnSurfaceInverse = R.attr.colorOnSurfaceInverse;
  public static int colorPrimaryInverse = R.attr.colorPrimaryInverse;
  public static int colorSurfaceDim = R.attr.colorSurfaceDim;
  public static int colorSurfaceBright = R.attr.colorSurfaceBright;
  public static int colorSurfaceContainerLowest = R.attr.colorSurfaceContainerLowest;
  public static int colorSurfaceContainerLow = R.attr.colorSurfaceContainerLow;
  public static int colorSurfaceContainer = R.attr.colorSurfaceContainer;
  public static int colorSurfaceContainerHigh = R.attr.colorSurfaceContainerHigh;
  public static int colorSurfaceContainerHighest = R.attr.colorSurfaceContainerHighest;
  ...
  public static int Back = colorSurface;
  public static int colorAccent = colorPrimary;
  public static int sfv = colorSurfaceVariant;
  public static int TvColor = colorOnSurface;
  public static int SecColor = colorPrimaryContainer;
  public static int ColorNormal = colorOnSurfaceVariant;
