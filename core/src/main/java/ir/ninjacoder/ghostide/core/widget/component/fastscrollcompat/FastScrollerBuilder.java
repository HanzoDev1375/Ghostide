...
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.FastScrollNestedScrollView;
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.FastScrollScrollView;
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.PopupStyles;
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.PopupTextProvider;
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.RecyclerViewHelper;
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.Utils;
import ir.ninjacoder.ghostide.core.widget.component.fastscrollcompat.ViewHelperProvider;

public class FastScrollerBuilder {

  @NonNull private final ViewGroup mView;

  @Nullable private FastScroller.ViewHelper mViewHelper;

  @Nullable private PopupTextProvider mPopupTextProvider;

  @Nullable private Rect mPadding;

  @NonNull private Drawable mTrackDrawable;

  @NonNull private Drawable mThumbDrawable;

  @NonNull private Consumer<TextView> mPopupStyle;

  @Nullable private FastScroller.AnimationHelper mAnimationHelper;
  ...
  private FastScroller.ViewHelper getOrCreateViewHelper() {
    ...
    if (mView instanceof ViewHelperProvider) {
      ...
      throw new UnsupportedOperationException(
          "Please use "
              + FastScrollNestedScrollView.class.getSimpleName()
              + " instead of "
      ...
      throw new UnsupportedOperationException(
          "Please use "
              + FastScrollScrollView.class.getSimpleName()
              + " instead of "
      ...
      throw new UnsupportedOperationException(
          "Please use "
              + FastScrollWebView.class.getSimpleName()
              + " instead of "
              + WebView.class.getSimpleName()
              + "for fast scroll");
    } else {
      throw new UnsupportedOperationException(
          mView.getClass().getSimpleName() + " is not supported for fast scroll");
    }
  }
