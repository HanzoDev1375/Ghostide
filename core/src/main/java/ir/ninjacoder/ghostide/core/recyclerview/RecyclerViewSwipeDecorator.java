package ir.ninjacoder.ghostide.core.recyclerview;
...
class RecyclerViewSwipeDecorator {
   ...
   */
  @Deprecated
  public RecyclerViewSwipeDecorator(
      Context context,
      Canvas canvas,
   ...
   * @deprecated in RecyclerViewSwipeDecorator 1.2, use {@link #setIconHorizontalMargin(int, int)}
   *     instead.
   */
  @Deprecated
  ...
  public void setSwipeLeftCornerRadius(int unit, float size) {
    mSwipeLeftCornerRadius =
        TypedValue.applyDimension(
            unit, size, recyclerView.getContext().getResources().getDisplayMetrics());
  }
  ...
  public void setSwipeLeftPadding(int unit, float top, float right, float bottom) {
    mSwipeLeftPadding =
        new int[] {
          (int)
              TypedValue.applyDimension(
                  unit, top, recyclerView.getContext().getResources().getDisplayMetrics()),
          (int)
              TypedValue.applyDimension(
                  unit, right, recyclerView.getContext().getResources().getDisplayMetrics()),
          (int)
              TypedValue.applyDimension(
                  unit, bottom, recyclerView.getContext().getResources().getDisplayMetrics())
        };
  }
  ...
  public void setSwipeRightPadding(int unit, float top, float left, float bottom) {
    mSwipeRightPadding =
        new int[] {
          ...
          (int)
              TypedValue.applyDimension(
                  unit, left, recyclerView.getContext().getResources().getDisplayMetrics()),
          (int)
              TypedValue.applyDimension(
                  unit, bottom, recyclerView.getContext().getResources().getDisplayMetrics())
        };
    ...
    try {
      ...
      if (dX > 0) {
        ...
        if (swipeRightBackgroundColor != 0) {
          if (mSwipeRightCornerRadius != 0) {
            ...
            background.setBounds(
                viewHolder.itemView.getLeft() + mSwipeRightPadding[1],
                viewHolder.itemView.getTop() + mSwipeRightPadding[0],
                viewHolder.itemView.getLeft() + (int) dX,
                viewHolder.itemView.getBottom() - mSwipeRightPadding[2]);
        ...
        if (swipeRightActionIconId != 0 && dX > iconHorizontalMargin) {
          Drawable icon =
              ContextCompat.getDrawable(recyclerView.getContext(), swipeRightActionIconId);
          if (icon != null) {
            ...
            int top =
                viewHolder.itemView.getTop()
                    + ((viewHolder.itemView.getBottom() - viewHolder.itemView.getTop()) / 2
                        - halfIcon);
            icon.setBounds(
                viewHolder.itemView.getLeft() + iconHorizontalMargin + mSwipeRightPadding[1],
                top,
                viewHolder.itemView.getLeft()
                    + iconHorizontalMargin
                    + mSwipeRightPadding[1]
        ...
        if (mSwipeRightText != null
          ...
          int textTop =
              (int)
                  (viewHolder.itemView.getTop()
                      + ((viewHolder.itemView.getBottom() - viewHolder.itemView.getTop()) / 2.0)
          ...
          canvas.drawText(
              ...
              viewHolder.itemView.getLeft()
                  ...
                  + mSwipeRightPadding[1]
                  + iconSize
                  + (iconSize > 0 ? iconHorizontalMargin / 2 : 0),
              textTop,
              textPaint);
        }
        ...
        if (swipeLeftBackgroundColor != 0) {
          if (mSwipeLeftCornerRadius != 0) {
            ...
            background.setBounds(
                viewHolder.itemView.getRight() + (int) dX,
                viewHolder.itemView.getTop() + mSwipeLeftPadding[0],
                viewHolder.itemView.getRight() - mSwipeLeftPadding[1],
                viewHolder.itemView.getBottom() - mSwipeLeftPadding[2]);
            background.setCornerRadii(
                new float[] {
                  0,
                  0,
        ...
        if (swipeLeftActionIconId != 0 && dX < -iconHorizontalMargin) {
          ...
          if (icon != null) {
            ...
            icon.setBounds(
                imgLeft,
                top,
                viewHolder.itemView.getRight() - iconHorizontalMargin - mSwipeLeftPadding[1],
                top + icon.getIntrinsicHeight());
        ...
        if (mSwipeLeftText != null
            ...
            && dX < -iconHorizontalMargin - mSwipeLeftPadding[1] - iconSize) {
          TextPaint textPaint = new TextPaint();
          textPaint.setAntiAlias(true);
          textPaint.setTextSize(
              TypedValue.applyDimension(
