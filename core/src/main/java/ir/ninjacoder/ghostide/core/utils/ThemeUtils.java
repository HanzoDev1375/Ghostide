...
public class ThemeUtils {
  ...
  public static String themeAsString() {
    return """
    {
      ...
      "fabbackgroundcolorcolor": "#ff252325",
      "htmlstr": "#E8BF6A",
      "pykeyword": "#ffff9339",
      "text_normal": "#ffebebeb",
      "tskeyword": "#ffff9339",
      "line_number_background": "#ff323535",
      "auto_comp_panel_corner": "#ffc6c6bb",
      "menuPosBackground": "#2b2b2b",
      "breaklevel8": "#ffffefb8",
      "breaklevel7": "#ffdcc6ff",
      "phpsymbol": "#ffd1ebd7",
      "breaklevel6": "#ffe3d5ff",
      "breaklevel5": "#ffff71e8",
      "breaklevel4": "#ff47ff91",
      "breaklevel3": "#ffffda71",
      "breaklevel2": "#ffff9cfd",
      "breaklevel1": "#ff8effff",
      "toolbarcolor": "#121212",
      "pynumber": "#A5D6A7",
      "javatype": "#ffc66d",
      "auto_comp_panel_bg": "#ff363636",
      "tssymbols": "#3357FF",
      "csskeyword": "#ffffd363",
      "literal": "#ffe88534",
      "toolbartextcolor": "#ffeaeaea",
      "phphtmlattr": "#fff0f0f0",
      "line_number": "#696969",
      "block_line_current": "#ffe14ba7",
      "tscolormatch3": "#ff997baa",
      "whole_background": "#2b2b2b",
      "tscolormatch4": "#ffd4d4d4",
      "attribute_name": "#9876aa",
      "tscolormatch1": "#F5D04D",
      "tscolormatch2": "#D04DF5",
      "tscolormatch7": "#ffff80d3",
      "javanumber": "#ffd5f1ff",
      "javakeywordoprator": "#ffffcc71",
      "menubackground": "#2b2b2b",
      "tscolormatch5": "#ACAA6C",
      "javakeyword": "#ffff9339",
      "tscolormatch6": "#fff3ff9c",
      "phpcolormatch3": "#FF8282",
      "phpcolormatch2": "#fffab5dd",
      "phpcolormatch5": "#ffffaada",
      "phpcolormatch4": "#ffff8ebe",
      "phpcolormatch6": "#ffb2b2b2",
      "line_divider": "#ff8e8e8e",
      "fabimagecolor": "#ffffffff",
      "textcolorforgrand": "#ffeaeaea",
      "navstatusbar": "#2b2b2b",
      "phpcolormatch1": "#ffccccc1",
      "current_line": "#52222424",
      "pystring": "#ffffcc71",
      "jskeyword": "#ffff9339",
      "textcolorinier": "#ffeaeaea",
      "javastring": "#ff67875a",
      "tsattr": "#9876aa",
      "backgroundcolorlinear": "#2b2b2b",
      "operator": "#FFB74D",
      "pysymbol": "#64B5F6",
      ...
      "keyword": "#ffff9339",
      "jsfun": "#ffffcc71",
      "pycolormatch3": "#ffff8ee8",
      "pycolormatch4": "#FFC300",
      "htmltag": "#FFAB49",
      "phphtmlkeyword": "#ffff9339",
      "htmlattrname": "#9876aa",
      "pycolormatch1": "#FFFF33",
      "pycolormatch2": "#33FFFF",
      "javaparament": "#ffcccccc",
      "identifier_name": "#FF9E80",
      "ninja": "#E1BEE7",
      "fabcolorstroker": "#4DFFFFFF",
      "htmlblocknormal": "#ffd7cbcb",
      "tabtextcolor": "#fff1ffff",
      "block_line": "#fffa928b",
      "htmlblockhash": "#ffb2b2a8",
      "menuPosTextColor": "#ffd1d1d1",
      "selection_insert": "#4DB6AC",
      "textcolorigor": "#fff0e3e3",
      "jsattr": "#9876aa",
      "imagecolor": "#B0BEC5",
      "phpattr": "#ffffc347",
      "jsstring": "#ff67875a",
      ...
      "htmlsymbol": "#ffe3d5ff",
      "print": "#FF8A65",
      "textcolorhder": "#ffffffff",
      "syombolbartextcolor": "#ffddddea",
      "displaytextcolortab": "#fffff1f1",
      "comment": "#757575",
