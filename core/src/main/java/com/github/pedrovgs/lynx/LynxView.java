...
public class LynxView extends LinearLayout implements LynxPresenter.View {
  ...
  private ir.ninjacoder.ghostide.core.layoutmanager.NestedScrollListView lv_traces;
  ...
  public void showTraces(List<Trace> traces, int removedTraces) {
    ...
    lv_traces.setOnItemClickListener(
        (a, b, c, d) -> {
          ...
          menu.setTextColor(
              MaterialColors.getColor(getContext(), ir.ninjacoder.ghostide.core.utils.ObjectUtils.colorOnSurface, 0));
          ...
          menu.setMenuColor(MaterialColors.getColor(getContext(), ir.ninjacoder.ghostide.core.utils.ObjectUtils.Back, 0));
  ...
  private void mapGui() {
    ...
    */
    ...
    input.setStartIconTintList(
        ColorStateList.valueOf(MaterialColors.getColor(input, ir.ninjacoder.ghostide.core.utils.ObjectUtils.TvColor)));
