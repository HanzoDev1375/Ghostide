package ir.ninjacoder.ghostide.widget.component;
...
public class LiveControlView extends FrameLayout
        implements IControlComponent, View.OnClickListener {
...

    {
        ...
        LayoutInflater.from(getContext())
                .inflate(R.layout.dkplayer_layout_live_control_view, this, true);
    ...
    protected void AnimationRunImageView(ImageView img) {
    }
}
