...
public class GhostWebView extends WebView {
     ...
     */
    protected static final String[] ALTERNATIVE_BROWSERS = new String[]{"org.mozilla.firefox", "com.android.chrome",
            "com.opera.browser", "org.mozilla.firefox_beta", "com.chrome.beta", "com.opera.browser.beta"};
    ...
    public static boolean isFileUploadAvailable(final boolean needsCorrectMimeType) {
        if (Build.VERSION.SDK_INT == 19) {
            ...
            return !needsCorrectMimeType
                    && (platformVersion.startsWith("4.4.3") || platformVersion.startsWith("4.4.4"));
        } else {
            return true;
        }
    }
     ...
     * @param fromUrl    the URL of the file to download, e.g. the one from `GhostWebView.onDownloadRequested(...)`
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, GhostWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
    ...
    protected void init(Context context) {
        ...
        setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String url, final String userAgent, final String contentDisposition,
                ...
                if (mListener != null) {
                    mListener.onDownloadRequested(url, suggestedFilename, mimeType, contentLength, contentDisposition,
                            userAgent);
                }
            }
    ...
    public interface Listener {
        ...
        void onDownloadRequested(String url, String suggestedFilename, String mimeType, long contentLength,
