...
public interface PhpParserListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by the {@code ChainExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ChainExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code SpecialWordExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code SpecialWordExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ArrayCreationExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ArrayCreationExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code BackQuoteStringExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code BackQuoteStringExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code MatchExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code MatchExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code PrintExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code PrintExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code PostfixIncDecExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code PostfixIncDecExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code CloneExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code CloneExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code UnaryOperatorExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code UnaryOperatorExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ParenthesisExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ParenthesisExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code SpaceshipExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code SpaceshipExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ConditionalExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ConditionalExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code NullCoalescingExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code NullCoalescingExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ArithmeticExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ArithmeticExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code IndexerExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code IndexerExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ScalarExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ScalarExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code PrefixIncDecExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code PrefixIncDecExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code CastExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code CastExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ArrayDestructExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ArrayDestructExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code LambdaFunctionExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code LambdaFunctionExpression} labeled alternative in
   * {@link PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code BitwiseExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code BitwiseExpression} labeled alternative in {@link
   * PhpParser#expression}.
   *
   * @param ctx the parse tree
   */
