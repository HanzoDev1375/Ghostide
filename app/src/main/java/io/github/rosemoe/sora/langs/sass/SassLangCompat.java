...
import io.github.rosemoe.sora.langs.sass.analyzer.SassAnalyzerCompat;
...
public class SassLangCompat implements EditorLanguage {
  ...
  public AutoCompleteProvider getAutoCompleteProvider() {
    IdentifierAutoComplete info = new IdentifierAutoComplete();
  ...
  public int getIndentAdvance(String content) {
    try {
      ScssLexer lexer = new ScssLexer(CharStreams.fromReader(new StringReader(content)));
      Token token;
      int advance = 0;
