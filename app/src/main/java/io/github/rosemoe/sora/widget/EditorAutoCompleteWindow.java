...
public class EditorAutoCompleteWindow extends EditorPopupWindow {
    ...
    public EditorAutoCompleteWindow(CodeEditor editor) {
        ...
        var vis =
                LayoutInflater.from(editor.getContext())
                        .inflate(R.layout.auto_textlayout, null, false);
        setContentView(vis);
        ...
        listview1.setOnItemClickListener(
                (parent, view, position, id) -> {
                    try {
                        ...
                        Toast.makeText(mEditor.getContext(), e.toString(), Toast.LENGTH_SHORT)
                                .show();
                    }
                });
    }
    ...
    private void ensurePosition() {
        listview1.post(
                () -> {
                    ...
                    while (listview1.getLastVisiblePosition() - 1 < mCurrent
                            && listview1.canScrollList(1)) {
                        performScrollList(-mAdapter.getItemHeight() / 2);
                    }
                });
    ...
    protected MaterialShapeDrawable colorAcsentDialog() {
        ...
        materialShapeDrawable.setStroke(
                2f,
                ColorStateList.valueOf(getThemeColor(EditorColorScheme.AUTO_COMP_PANEL_CORNER)));
