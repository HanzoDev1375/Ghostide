    ...
    while (delegate.shouldAnalyze()) {
      ...
      switch (token.getType()) {
        ...
        case smaliParser.VOID_TYPE:
          colors.addIfNeeded(
              line, column, TextStyle.makeStyle(EditorColorScheme.KEYWORD, 0, true, false, false));
        ...
        case smaliParser.REGISTER:
          colors.addIfNeeded(
              line, column, TextStyle.makeStyle(EditorColorScheme.HTML_TAG, 0, true, false, false));
          break;
        ...
        case smaliParser.SIMPLE_NAME:
          colors.addIfNeeded(
              line,
              column,
              TextStyle.makeStyle(EditorColorScheme.BLOCK_LINE_CURRENT, 0, true, false, false));
          break;
        ...
        case smaliParser.LINE_COMMENT:
          colors.addIfNeeded(
              line, column, TextStyle.makeStyle(EditorColorScheme.COMMENT, 0, true, false, false));
          break;
