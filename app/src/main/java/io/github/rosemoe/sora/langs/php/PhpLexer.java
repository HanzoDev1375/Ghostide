// Generated from /storage/emulated/0/Download/Browser/PhpLexer.g4 by ANTLR 4.13.1
...
public class PhpLexer extends Lexer {
	...
	public static final int
		SPACE=1, MultiLineComment=2, SingleLineComment=3, ShellStyleComment=4, 
		PhpStart=5, PhpEnd=6, IDENTIFIER=7, HEXCOLOR=8, Abstract=9, Array=10, 
		As=11, BinaryCast=12, BoolType=13, BooleanConstant=14, Break=15, Callable=16, 
		Case=17, Catch=18, Class=19, Clone=20, Const=21, Continue=22, Declare=23, 
		Default=24, Do=25, DoubleCast=26, DoubleType=27, Echo=28, Else=29, ElseIf=30, 
		Empty=31, Enum_=32, EndDeclare=33, EndFor=34, EndForeach=35, EndIf=36, 
		EndSwitch=37, EndWhile=38, Eval=39, Exit=40, Extends=41, Final=42, Finally=43, 
		FloatCast=44, For=45, Foreach=46, Function_=47, Global=48, Goto=49, If=50, 
		Implements=51, Import=52, Include=53, IncludeOnce=54, InstanceOf=55, InsteadOf=56, 
		Int8Cast=57, Int16Cast=58, Int64Type=59, IntType=60, Interface=61, IsSet=62, 
		List=63, LogicalAnd=64, LogicalOr=65, LogicalXor=66, Match_=67, Namespace=68, 
		New=69, Null=70, ObjectType=71, Parent_=72, Partial=73, Print=74, Private=75, 
		Protected=76, Public=77, Readonly=78, Require=79, RequireOnce=80, Resource=81, 
		Return=82, Static=83, StringType=84, Switch=85, Throw=86, Trait=87, Try=88, 
		Typeof=89, UintCast=90, UnicodeCast=91, Unset=92, Use=93, Var=94, While=95, 
		Yield=96, From=97, LambdaFn=98, Ticks=99, Encoding=100, StrictTypes=101, 
		Get=102, Set=103, Call=104, CallStatic=105, Constructor=106, Destruct=107, 
		Wakeup=108, Sleep=109, Autoload=110, IsSet__=111, Unset__=112, ToString__=113, 
		Invoke=114, SetState=115, Clone__=116, DebugInfo=117, Namespace__=118, 
		Class__=119, Traic__=120, Function__=121, Method__=122, Line__=123, File__=124, 
		Dir__=125, Spaceship=126, Lgeneric=127, Rgeneric=128, DoubleArrow=129, 
		Inc=130, Dec=131, IsIdentical=132, IsNoidentical=133, IsEqual=134, IsNotEq=135, 
		IsSmallerOrEqual=136, IsGreaterOrEqual=137, PlusEqual=138, MinusEqual=139, 
		MulEqual=140, Pow=141, PowEqual=142, DivEqual=143, Concaequal=144, ModEqual=145, 
		ShiftLeftEqual=146, ShiftRightEqual=147, AndEqual=148, OrEqual=149, XorEqual=150, 
		BooleanOr=151, BooleanAnd=152, NullCoalescing=153, NullCoalescingEqual=154, 
		ShiftLeft=155, ShiftRight=156, DoubleColon=157, ObjectOperator=158, NamespaceSeparator=159, 
		Ellipsis=160, Less=161, Greater=162, Ampersand=163, Pipe=164, Bang=165, 
		Caret=166, Plus=167, Minus=168, Asterisk=169, Percent=170, Divide=171, 
		Tilde=172, SuppressWarnings=173, Dollar=174, Dot=175, QuestionMark=176, 
		OpenRoundBracket=177, CloseRoundBracket=178, OpenSquareBracket=179, CloseSquareBracket=180, 
		OpenCurlyBracket=181, CloseCurlyBracket=182, Comma=183, Colon=184, SemiColon=185, 
		Eq=186, Quote=187, BackQuote=188;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SPACE", "MultiLineComment", "SingleLineComment", "ShellStyleComment", 
			"PhpStart", "PhpEnd", "HEXCAHR", "NUMBER", "IDENTIFIER", "LetterOrDigit", 
			"Letter", "HEXCOLOR", "Abstract", "Array", "As", "BinaryCast", "BoolType", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "SPACE", "MultiLineComment", "SingleLineComment", "ShellStyleComment", 
			"PhpStart", "PhpEnd", "IDENTIFIER", "HEXCOLOR", "Abstract", "Array", 
