...
import ir.ninjacoder.prograsssheet.util.AndroidUtils;
...
public class LiquidGlassEffect {
  ...
  public LiquidGlassEffect(RenderNode node,Context context) {
    this.node = node;
    final String code = AndroidUtils.readRes(R.raw.liquid_glass_shader,context);
  ...
  public void update(
    ...
    if (Math.abs(this.resolutionX - resolutionX) > 0.1f
      ...
      shader.setFloatUniform(
          "resolution", this.resolutionX = resolutionX, this.resolutionY = resolutionY);
